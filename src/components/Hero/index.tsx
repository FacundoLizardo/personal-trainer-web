    ...
    <>
      ...
      >
        ...
        <div className="container mb-64">
          <div className="-mx-4 mt-36 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1
                  className="mb-5 text-5xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                ...
                <p
                  ...
                  Aprende a entrenar y alimentarte para convertirte en tu mejor versión.
                </p>
                <div
